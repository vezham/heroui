...
export function ScriptProviders({ isKapaEnabled = true }: { isKapaEnabled?: boolean }) {
  ...
  return (
      <Script
        defer
        data-modal-disclaimer="This is a custom LLM for HeroUI with access to all developer docs (heroui.com/docs) and GitHub Issues and PRs (github.com/vezham/heroui)."

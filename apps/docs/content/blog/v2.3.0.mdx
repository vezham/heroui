...
import {HeroUIProvider, SupportedCalendars} from "@vx-oss/react";
...
- Patched the "@vx-oss/autocomplete" package to fix an issue where empty items with `allowCustomValue` would not render properly due to a null node problem. [PR](https://github.com/vezham/heroui/pull/2674) - [@wingkwong](https://github.com/wingkwong)
...
- Patched issues in "@vx-oss/use-aria-multiselect" and "@vx-oss/stories-utils" packages to fix a warning about `SELECT defaultSelectedKeys`. [PR](https://github.com/vezham/heroui/pull/2648) - [@wingkwong](https://github.com/wingkwong)

...
<PackageManagers
  commands={{
    npm: "npm install @v0xoss/react@latest framer-motion@latest",
    pnpm: "pnpm add @v0xoss/react@latest framer-motion@latest",
    yarn: "yarn add @v0xoss/react@latest framer-motion@latest",
    bun: "bun add @v0xoss/react@latest framer-motion@latest",
  }}
/>
...
```diff-tsx
// Before
- "./node_modules/@v0xoss/theme/dist/components/circular-progress.js";

// After
+ "./node_modules/@v0xoss/theme/dist/components/progress.js";
```

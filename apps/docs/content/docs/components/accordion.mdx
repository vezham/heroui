...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/accordion",
    yarn: "yarn add @v0xoss/accordion",
    pnpm: "pnpm add @v0xoss/accordion",
    bun: "bun add @v0xoss/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@v0xoss/react";',
    individual: 'import {Accordion, AccordionItem} from "@v0xoss/accordion";',
  }}
/>

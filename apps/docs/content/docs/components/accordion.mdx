...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/accordion",
    yarn: "yarn add @vx-oss/accordion",
    pnpm: "pnpm add @vx-oss/accordion",
    bun: "bun add @vx-oss/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@vx-oss/react";',
    individual: 'import {Accordion, AccordionItem} from "@vx-oss/accordion";',
  }}
/>

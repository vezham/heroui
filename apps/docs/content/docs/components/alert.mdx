...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/alert",
    yarn: "yarn add @v0xoss/alert",
    pnpm: "pnpm add @v0xoss/alert",
    bun: "bun add @v0xoss/alert",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Alert} from "@v0xoss/react";',
    individual: 'import {Alert} from "@v0xoss/alert";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/alert",
    yarn: "yarn add @vx-oss/alert",
    pnpm: "pnpm add @vx-oss/alert",
    bun: "bun add @vx-oss/alert",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Alert} from "@vx-oss/react";',
    individual: 'import {Alert} from "@vx-oss/alert";',
  }}
/>

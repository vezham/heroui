...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/autocomplete",
    yarn: "yarn add @vx-oss/autocomplete",
    pnpm: "pnpm add @vx-oss/autocomplete",
    bun: "bun add @vx-oss/autocomplete",
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/autocomplete",
    yarn: "yarn add @v0xoss/autocomplete",
    pnpm: "pnpm add @v0xoss/autocomplete",
    bun: "bun add @v0xoss/autocomplete",
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/autocomplete",
    yarn: "yarn add @vezham/autocomplete",
    pnpm: "pnpm add @vezham/autocomplete",
    bun: "bun add @vezham/autocomplete",
  }}
/>

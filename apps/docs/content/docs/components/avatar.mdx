...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/avatar",
    yarn: "yarn add @vx-oss/avatar",
    pnpm: "pnpm add @vx-oss/avatar",
    bun: "bun add @vx-oss/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vx-oss/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vx-oss/avatar";',
  }}
/>

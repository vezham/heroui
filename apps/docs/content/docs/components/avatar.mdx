...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/avatar",
    yarn: "yarn add @v0xoss/avatar",
    pnpm: "pnpm add @v0xoss/avatar",
    bun: "bun add @v0xoss/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@v0xoss/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@v0xoss/avatar";',
  }}
/>

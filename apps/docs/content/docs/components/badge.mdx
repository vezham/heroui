...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/badge",
    yarn: "yarn add @vx-oss/badge",
    pnpm: "pnpm add @vx-oss/badge",
    bun: "bun add @vx-oss/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@vx-oss/react";',
    individual: 'import {Badge} from "@vx-oss/badge";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/badge",
    yarn: "yarn add @v0xoss/badge",
    pnpm: "pnpm add @v0xoss/badge",
    bun: "bun add @v0xoss/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@v0xoss/react";',
    individual: 'import {Badge} from "@v0xoss/badge";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/breadcrumbs",
    yarn: "yarn add @v0xoss/breadcrumbs",
    pnpm: "pnpm add @v0xoss/breadcrumbs",
    bun: "bun add @v0xoss/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@v0xoss/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@v0xoss/breadcrumbs";',
  }}
/>

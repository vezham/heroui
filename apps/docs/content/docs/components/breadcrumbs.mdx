...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/breadcrumbs",
    yarn: "yarn add @vx-oss/breadcrumbs",
    pnpm: "pnpm add @vx-oss/breadcrumbs",
    bun: "bun add @vx-oss/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@vx-oss/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@vx-oss/breadcrumbs";',
  }}
/>

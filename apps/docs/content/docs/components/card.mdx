...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/card",
    yarn: "yarn add @vx-oss/card",
    pnpm: "pnpm add @vx-oss/card",
    bun: "bun add @vx-oss/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@vx-oss/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@vx-oss/card";',
  }}
/>

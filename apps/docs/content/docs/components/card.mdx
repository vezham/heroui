...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/card",
    yarn: "yarn add @v0xoss/card",
    pnpm: "pnpm add @v0xoss/card",
    bun: "bun add @v0xoss/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@v0xoss/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@v0xoss/card";',
  }}
/>

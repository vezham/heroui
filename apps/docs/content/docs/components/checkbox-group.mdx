...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/checkbox",
    yarn: "yarn add @v0xoss/checkbox",
    pnpm: "pnpm add @v0xoss/checkbox",
    bun: "bun add @v0xoss/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@v0xoss/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@v0xoss/checkbox";',
  }}
/>

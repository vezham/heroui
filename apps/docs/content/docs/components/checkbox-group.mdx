...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/checkbox",
    yarn: "yarn add @vx-oss/checkbox",
    pnpm: "pnpm add @vx-oss/checkbox",
    bun: "bun add @vx-oss/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@vx-oss/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@vx-oss/checkbox";',
  }}
/>

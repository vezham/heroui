...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/chip",
    yarn: "yarn add @vx-oss/chip",
    pnpm: "pnpm add @vx-oss/chip",
    bun: "bun add @vx-oss/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@vx-oss/react";',
    individual: 'import {Chip} from "@vx-oss/chip";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/chip",
    yarn: "yarn add @v0xoss/chip",
    pnpm: "pnpm add @v0xoss/chip",
    bun: "bun add @v0xoss/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@v0xoss/react";',
    individual: 'import {Chip} from "@v0xoss/chip";',
  }}
/>

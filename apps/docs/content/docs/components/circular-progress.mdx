...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/progress",
    yarn: "yarn add @v0xoss/progress",
    pnpm: "pnpm add @v0xoss/progress",
    bun: "bun add @v0xoss/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@v0xoss/react";',
    individual: 'import {CircularProgress} from "@v0xoss/progress";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/progress",
    yarn: "yarn add @vx-oss/progress",
    pnpm: "pnpm add @vx-oss/progress",
    bun: "bun add @vx-oss/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@vx-oss/react";',
    individual: 'import {CircularProgress} from "@vx-oss/progress";',
  }}
/>

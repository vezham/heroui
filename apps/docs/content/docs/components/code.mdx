...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/code",
    yarn: "yarn add @vx-oss/code",
    pnpm: "pnpm add @vx-oss/code",
    bun: "bun add @vx-oss/code"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Code} from "@vx-oss/react";',
    individual: 'import {Code} from "@vx-oss/code";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/date-input",
    yarn: "yarn add @vezham/date-input",
    pnpm: "pnpm add @vezham/date-input",
    bun: "bun add @vezham/date-input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateInput} from "@vezham/react";',
    individual: 'import {DateInput} from "@vezham/date-input";',
  }}
/>

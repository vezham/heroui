...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/date-input",
    yarn: "yarn add @v0xoss/date-input",
    pnpm: "pnpm add @v0xoss/date-input",
    bun: "bun add @v0xoss/date-input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateInput} from "@v0xoss/react";',
    individual: 'import {DateInput} from "@v0xoss/date-input";',
  }}
/>

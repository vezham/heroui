...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/date-picker",
    yarn: "yarn add @vezham/date-picker",
    pnpm: "pnpm add @vezham/date-picker",
    bun: "bun add @vezham/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@vezham/react";',
    individual: 'import {DateRangePicker} from "@vezham/date-picker";',
  }}
/>

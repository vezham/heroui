...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/date-picker",
    yarn: "yarn add @vx-oss/date-picker",
    pnpm: "pnpm add @vx-oss/date-picker",
    bun: "bun add @vx-oss/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@vx-oss/react";',
    individual: 'import {DateRangePicker} from "@vx-oss/date-picker";',
  }}
/>

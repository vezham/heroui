...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/date-picker",
    yarn: "yarn add @v0xoss/date-picker",
    pnpm: "pnpm add @v0xoss/date-picker",
    bun: "bun add @v0xoss/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@v0xoss/react";',
    individual: 'import {DateRangePicker} from "@v0xoss/date-picker";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/divider",
    yarn: "yarn add @v0xoss/divider",
    pnpm: "pnpm add @v0xoss/divider",
    bun: "bun add @v0xoss/divider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Divider} from "@v0xoss/react";',
    individual: 'import {Divider} from "@v0xoss/divider";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/dropdown",
    yarn: "yarn add @v0xoss/dropdown",
    pnpm: "pnpm add @v0xoss/dropdown",
    bun: "bun add @v0xoss/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@v0xoss/react";

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/dropdown",
    yarn: "yarn add @vx-oss/dropdown",
    pnpm: "pnpm add @vx-oss/dropdown",
    bun: "bun add @vx-oss/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@vx-oss/react";

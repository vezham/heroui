...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/form",
    yarn: "yarn add @v0xoss/form",
    pnpm: "pnpm add @v0xoss/form",
    bun: "bun add @v0xoss/form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@v0xoss/react";',
    individual: 'import {Form} from "@v0xoss/form";',
  }}
/>
...
```tsx
import {Form, Button} from '@v0xoss/react';

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/form",
    yarn: "yarn add @vezham/form",
    pnpm: "pnpm add @vezham/form",
    bun: "bun add @vezham/form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@vezham/react";',
    individual: 'import {Form} from "@vezham/form";',
  }}
/>
...
```tsx
import {Form, Button} from '@vezham/react';

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/form",
    yarn: "yarn add @vx-oss/form",
    pnpm: "pnpm add @vx-oss/form",
    bun: "bun add @vx-oss/form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@vx-oss/react";',
    individual: 'import {Form} from "@vx-oss/form";',
  }}
/>
...
```tsx
import {Form, Button} from '@vx-oss/react';

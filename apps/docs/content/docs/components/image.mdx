...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/image",
    yarn: "yarn add @vx-oss/image",
    pnpm: "pnpm add @vx-oss/image",
    bun: "bun add @vx-oss/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@vx-oss/react";',
    individual: 'import {Image} from "@vx-oss/image";',
  }}
/>

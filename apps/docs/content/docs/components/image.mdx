...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/image",
    yarn: "yarn add @v0xoss/image",
    pnpm: "pnpm add @v0xoss/image",
    bun: "bun add @v0xoss/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@v0xoss/react";',
    individual: 'import {Image} from "@v0xoss/image";',
  }}
/>

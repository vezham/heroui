...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/input-otp",
    yarn: "yarn add @v0xoss/input-otp",
    pnpm: "pnpm add @v0xoss/input-otp",
    bun: "bun add @v0xoss/input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@v0xoss/react";',
    individual: 'import {InputOtp} from "@v0xoss/input-otp";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/input-otp",
    yarn: "yarn add @vx-oss/input-otp",
    pnpm: "pnpm add @vx-oss/input-otp",
    bun: "bun add @vx-oss/input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@vx-oss/react";',
    individual: 'import {InputOtp} from "@vx-oss/input-otp";',
  }}
/>

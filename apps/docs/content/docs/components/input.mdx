...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/input",
    yarn: "yarn add @vezham/input",
    pnpm: "pnpm add @vezham/input",
    bun: "bun add @vezham/input"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Input} from "@vezham/react";',
    individual: 'import {Input} from "@vezham/input";',
  }}
/>

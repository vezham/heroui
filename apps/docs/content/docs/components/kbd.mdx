...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/kbd",
    yarn: "yarn add @vx-oss/kbd",
    pnpm: "pnpm add @vx-oss/kbd",
    bun: "bun add @vx-oss/kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@vx-oss/react";',
    individual: 'import {Kbd} from "@vx-oss/kbd";',
  }}
/>

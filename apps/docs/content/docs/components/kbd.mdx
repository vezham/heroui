...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/kbd",
    yarn: "yarn add @vezham/kbd",
    pnpm: "pnpm add @vezham/kbd",
    bun: "bun add @vezham/kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@vezham/react";',
    individual: 'import {Kbd} from "@vezham/kbd";',
  }}
/>

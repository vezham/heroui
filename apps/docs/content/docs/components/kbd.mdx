...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/kbd",
    yarn: "yarn add @v0xoss/kbd",
    pnpm: "pnpm add @v0xoss/kbd",
    bun: "bun add @v0xoss/kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@v0xoss/react";',
    individual: 'import {Kbd} from "@v0xoss/kbd";',
  }}
/>

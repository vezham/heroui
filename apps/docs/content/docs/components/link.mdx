...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/link",
    yarn: "yarn add @vx-oss/link",
    pnpm: "pnpm add @vx-oss/link",
    bun: "bun add @vx-oss/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@vx-oss/react";',
    individual: 'import {Link} from "@vx-oss/link";',
  }}
/>

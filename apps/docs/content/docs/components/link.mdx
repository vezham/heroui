...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/link",
    yarn: "yarn add @v0xoss/link",
    pnpm: "pnpm add @v0xoss/link",
    bun: "bun add @v0xoss/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@v0xoss/react";',
    individual: 'import {Link} from "@v0xoss/link";',
  }}
/>

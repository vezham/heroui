...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/pagination",
    yarn: "yarn add @v0xoss/pagination",
    pnpm: "pnpm add @v0xoss/pagination",
    bun: "bun add @v0xoss/pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@v0xoss/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@v0xoss/pagination";',
  }}
/>

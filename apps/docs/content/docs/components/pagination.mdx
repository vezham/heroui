...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/pagination",
    yarn: "yarn add @vx-oss/pagination",
    pnpm: "pnpm add @vx-oss/pagination",
    bun: "bun add @vx-oss/pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@vx-oss/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@vx-oss/pagination";',
  }}
/>

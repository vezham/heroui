...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/popover",
    yarn: "yarn add @vx-oss/popover",
    pnpm: "pnpm add @vx-oss/popover",
    bun: "bun add @vx-oss/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@vx-oss/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@vx-oss/popover";',
  }}
/>

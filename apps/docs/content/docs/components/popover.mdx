...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/popover",
    yarn: "yarn add @vezham/popover",
    pnpm: "pnpm add @vezham/popover",
    bun: "bun add @vezham/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@vezham/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@vezham/popover";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/popover",
    yarn: "yarn add @v0xoss/popover",
    pnpm: "pnpm add @v0xoss/popover",
    bun: "bun add @v0xoss/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@v0xoss/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@v0xoss/popover";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/radio",
    yarn: "yarn add @vx-oss/radio",
    pnpm: "pnpm add @vx-oss/radio",
    bun: "bun add @vx-oss/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@vx-oss/react";',
    individual: 'import {RadioGroup, Radio} from "@vx-oss/radio";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/radio",
    yarn: "yarn add @v0xoss/radio",
    pnpm: "pnpm add @v0xoss/radio",
    bun: "bun add @v0xoss/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@v0xoss/react";',
    individual: 'import {RadioGroup, Radio} from "@v0xoss/radio";',
  }}
/>

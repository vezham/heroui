...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/calendar",
    yarn: "yarn add @v0xoss/calendar",
    pnpm: "pnpm add @v0xoss/calendar",
    bun: "bun add @v0xoss/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@v0xoss/react";',
    individual: 'import {RangeCalendar} from "@v0xoss/calendar";',
  }}
/>

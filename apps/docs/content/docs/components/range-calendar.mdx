...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/calendar",
    yarn: "yarn add @vx-oss/calendar",
    pnpm: "pnpm add @vx-oss/calendar",
    bun: "bun add @vx-oss/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@vx-oss/react";',
    individual: 'import {RangeCalendar} from "@vx-oss/calendar";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/calendar",
    yarn: "yarn add @vezham/calendar",
    pnpm: "pnpm add @vezham/calendar",
    bun: "bun add @vezham/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@vezham/react";',
    individual: 'import {RangeCalendar} from "@vezham/calendar";',
  }}
/>

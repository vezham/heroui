...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/scroll-shadow",
    yarn: "yarn add @v0xoss/scroll-shadow",
    pnpm: "pnpm add @v0xoss/scroll-shadow",
    bun: "bun add @v0xoss/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@v0xoss/react";',
    individual: 'import {ScrollShadow} from "@v0xoss/scroll-shadow";',
  }}
/>

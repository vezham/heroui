...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/scroll-shadow",
    yarn: "yarn add @vx-oss/scroll-shadow",
    pnpm: "pnpm add @vx-oss/scroll-shadow",
    bun: "bun add @vx-oss/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@vx-oss/react";',
    individual: 'import {ScrollShadow} from "@vx-oss/scroll-shadow";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/select",
    yarn: "yarn add @v0xoss/select",
    pnpm: "pnpm add @v0xoss/select",
    bun: "bun add @v0xoss/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@v0xoss/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@v0xoss/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @v0xoss/use-infinite-scroll",
    yarn: "yarn add @v0xoss/use-infinite-scroll",
    pnpm: "pnpm add @v0xoss/use-infinite-scroll",
  }}
/>

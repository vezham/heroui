...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/select",
    yarn: "yarn add @vezham/select",
    pnpm: "pnpm add @vezham/select",
    bun: "bun add @vezham/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@vezham/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@vezham/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vezham/use-infinite-scroll",
    yarn: "yarn add @vezham/use-infinite-scroll",
    pnpm: "pnpm add @vezham/use-infinite-scroll",
  }}
/>

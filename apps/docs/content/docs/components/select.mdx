...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/select",
    yarn: "yarn add @vx-oss/select",
    pnpm: "pnpm add @vx-oss/select",
    bun: "bun add @vx-oss/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@vx-oss/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@vx-oss/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/use-infinite-scroll",
    yarn: "yarn add @vx-oss/use-infinite-scroll",
    pnpm: "pnpm add @vx-oss/use-infinite-scroll",
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/skeleton",
    yarn: "yarn add @vx-oss/skeleton",
    pnpm: "pnpm add @vx-oss/skeleton",
    bun: "bun add @vx-oss/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@vx-oss/react";',
    individual: 'import {Skeleton} from "@vx-oss/skeleton";',
  }}
/>

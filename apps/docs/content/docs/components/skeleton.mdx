...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/skeleton",
    yarn: "yarn add @v0xoss/skeleton",
    pnpm: "pnpm add @v0xoss/skeleton",
    bun: "bun add @v0xoss/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@v0xoss/react";',
    individual: 'import {Skeleton} from "@v0xoss/skeleton";',
  }}
/>

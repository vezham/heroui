...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/slider",
    yarn: "yarn add @vx-oss/slider",
    pnpm: "pnpm add @vx-oss/slider",
    bun: "bun add @vx-oss/slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@vx-oss/react";',
    individual: 'import {Slider} from "@vx-oss/slider";',
  }}
/>

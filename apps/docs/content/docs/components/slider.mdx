...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/slider",
    yarn: "yarn add @v0xoss/slider",
    pnpm: "pnpm add @v0xoss/slider",
    bun: "bun add @v0xoss/slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@v0xoss/react";',
    individual: 'import {Slider} from "@v0xoss/slider";',
  }}
/>

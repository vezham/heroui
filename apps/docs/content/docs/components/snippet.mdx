...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/snippet",
    yarn: "yarn add @vx-oss/snippet",
    pnpm: "pnpm add @vx-oss/snippet",
    bun: "bun add @vx-oss/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@vx-oss/react";',
    individual: 'import {Snippet} from "@vx-oss/snippet";',
  }}
/>

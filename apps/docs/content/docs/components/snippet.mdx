...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/snippet",
    yarn: "yarn add @v0xoss/snippet",
    pnpm: "pnpm add @v0xoss/snippet",
    bun: "bun add @v0xoss/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@v0xoss/react";',
    individual: 'import {Snippet} from "@v0xoss/snippet";',
  }}
/>

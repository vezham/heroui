...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/spacer",
    yarn: "yarn add @vx-oss/spacer",
    pnpm: "pnpm add @vx-oss/spacer",
    bun: "bun add @vx-oss/spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@vx-oss/react";',
    individual: 'import {Spacer} from "@vx-oss/spacer";',
  }}
/>

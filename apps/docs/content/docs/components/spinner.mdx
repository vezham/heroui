...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/spinner",
    yarn: "yarn add @v0xoss/spinner",
    pnpm: "pnpm add @v0xoss/spinner",
    bun: "bun add @v0xoss/spinner"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spinner} from "@v0xoss/react";',
    individual: 'import {Spinner} from "@v0xoss/spinner";',
  }}
/>

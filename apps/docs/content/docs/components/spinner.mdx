...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/spinner",
    yarn: "yarn add @vx-oss/spinner",
    pnpm: "pnpm add @vx-oss/spinner",
    bun: "bun add @vx-oss/spinner"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spinner} from "@vx-oss/react";',
    individual: 'import {Spinner} from "@vx-oss/spinner";',
  }}
/>

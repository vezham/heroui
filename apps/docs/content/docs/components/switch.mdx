...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/switch",
    yarn: "yarn add @vx-oss/switch",
    pnpm: "pnpm add @vx-oss/switch",
    bun: "bun add @vx-oss/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@vx-oss/react";',
    individual: 'import {Switch} from "@vx-oss/switch";',
  }}
/>

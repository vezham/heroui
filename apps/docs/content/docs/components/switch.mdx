...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/switch",
    yarn: "yarn add @v0xoss/switch",
    pnpm: "pnpm add @v0xoss/switch",
    bun: "bun add @v0xoss/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@v0xoss/react";',
    individual: 'import {Switch} from "@v0xoss/switch";',
  }}
/>

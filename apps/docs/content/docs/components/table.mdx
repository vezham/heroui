...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/table",
    yarn: "yarn add @vezham/table",
    pnpm: "pnpm add @vezham/table",
    bun: "bun add @vezham/table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@vezham/react";
...
[@vezham/use-infinite-scroll](https://www.npmjs.com/package/@vezham/use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @vezham/use-infinite-scroll",
    yarn: "yarn add @react-stately/data @vezham/use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @vezham/use-infinite-scroll",
    bun: "bun add @react-stately/data @vezham/use-infinite-scroll",
  }}
/>

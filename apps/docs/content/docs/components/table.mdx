...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/table",
    yarn: "yarn add @vx-oss/table",
    pnpm: "pnpm add @vx-oss/table",
    bun: "bun add @vx-oss/table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@vx-oss/react";
...
[@vx-oss/use-infinite-scroll](https://www.npmjs.com/package/@vx-oss/use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @vx-oss/use-infinite-scroll",
    yarn: "yarn add @react-stately/data @vx-oss/use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @vx-oss/use-infinite-scroll",
    bun: "bun add @react-stately/data @vx-oss/use-infinite-scroll",
  }}
/>

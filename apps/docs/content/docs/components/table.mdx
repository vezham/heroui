...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/table",
    yarn: "yarn add @v0xoss/table",
    pnpm: "pnpm add @v0xoss/table",
    bun: "bun add @v0xoss/table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@v0xoss/react";
...
[@v0xoss/use-infinite-scroll](https://www.npmjs.com/package/@v0xoss/use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @v0xoss/use-infinite-scroll",
    yarn: "yarn add @react-stately/data @v0xoss/use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @v0xoss/use-infinite-scroll",
    bun: "bun add @react-stately/data @v0xoss/use-infinite-scroll",
  }}
/>

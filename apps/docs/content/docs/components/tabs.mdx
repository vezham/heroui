...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/tabs",
    yarn: "yarn add @vezham/tabs",
    pnpm: "pnpm add @vezham/tabs",
    bun: "bun add @vezham/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@vezham/react";',
    individual: 'import {Tabs, Tab} from "@vezham/tabs";',
  }}
/>

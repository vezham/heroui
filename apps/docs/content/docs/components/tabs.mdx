...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/tabs",
    yarn: "yarn add @v0xoss/tabs",
    pnpm: "pnpm add @v0xoss/tabs",
    bun: "bun add @v0xoss/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@v0xoss/react";',
    individual: 'import {Tabs, Tab} from "@v0xoss/tabs";',
  }}
/>

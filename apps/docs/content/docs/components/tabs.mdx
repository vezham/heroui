...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/tabs",
    yarn: "yarn add @vx-oss/tabs",
    pnpm: "pnpm add @vx-oss/tabs",
    bun: "bun add @vx-oss/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@vx-oss/react";',
    individual: 'import {Tabs, Tab} from "@vx-oss/tabs";',
  }}
/>

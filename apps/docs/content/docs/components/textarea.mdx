...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/input",
    yarn: "yarn add @v0xoss/input",
    pnpm: "pnpm add @v0xoss/input",
    bun: "bun add @v0xoss/input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@v0xoss/react";',
    individual: 'import {Textarea} from "@v0xoss/input";',
  }}
/>

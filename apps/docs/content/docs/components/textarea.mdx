...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/input",
    yarn: "yarn add @vx-oss/input",
    pnpm: "pnpm add @vx-oss/input",
    bun: "bun add @vx-oss/input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@vx-oss/react";',
    individual: 'import {Textarea} from "@vx-oss/input";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/date-input",
    yarn: "yarn add @vx-oss/date-input",
    pnpm: "pnpm add @vx-oss/date-input",
    bun: "bun add @vx-oss/date-input"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {TimeInput} from "@vx-oss/react";',
    individual: 'import {TimeInput} from "@vx-oss/date-input";',
  }}
/>

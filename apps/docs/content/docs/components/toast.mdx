...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/toast",
    yarn: "yarn add @vezham/toast",
    pnpm: "pnpm add @vezham/toast",
    bun: "bun add @vezham/toast",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {addToast, ToastProvider} from "@vezham/react";',
    individual: 'import {addToast, ToastProvider} from "@vezham/toast";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/toast",
    yarn: "yarn add @v0xoss/toast",
    pnpm: "pnpm add @v0xoss/toast",
    bun: "bun add @v0xoss/toast",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {addToast, ToastProvider} from "@v0xoss/react";',
    individual: 'import {addToast, ToastProvider} from "@v0xoss/toast";',
  }}
/>

...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/toast",
    yarn: "yarn add @vx-oss/toast",
    pnpm: "pnpm add @vx-oss/toast",
    bun: "bun add @vx-oss/toast",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {addToast, ToastProvider} from "@vx-oss/react";',
    individual: 'import {addToast, ToastProvider} from "@vx-oss/toast";',
  }}
/>

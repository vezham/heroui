...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/tooltip",
    yarn: "yarn add @v0xoss/tooltip",
    pnpm: "pnpm add @v0xoss/tooltip",
    bun: "bun add @v0xoss/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@v0xoss/react";',
    individual: 'import {Tooltip} from "@v0xoss/tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@v0xoss/theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.

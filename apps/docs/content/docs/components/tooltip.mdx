...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/tooltip",
    yarn: "yarn add @vx-oss/tooltip",
    pnpm: "pnpm add @vx-oss/tooltip",
    bun: "bun add @vx-oss/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@vx-oss/react";',
    individual: 'import {Tooltip} from "@vx-oss/tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@vx-oss/theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.

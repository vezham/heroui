...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vezham/tooltip",
    yarn: "yarn add @vezham/tooltip",
    pnpm: "pnpm add @vezham/tooltip",
    bun: "bun add @vezham/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@vezham/react";',
    individual: 'import {Tooltip} from "@vezham/tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@vezham/theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.

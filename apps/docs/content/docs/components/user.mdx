...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/user",
    yarn: "yarn add @vx-oss/user",
    pnpm: "pnpm add @vx-oss/user",
    bun: "bun add @vx-oss/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@vx-oss/react";',
    individual: 'import {User} from "@vx-oss/user";',
  }}
/>

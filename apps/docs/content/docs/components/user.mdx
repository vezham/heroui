...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @v0xoss/user",
    yarn: "yarn add @v0xoss/user",
    pnpm: "pnpm add @v0xoss/user",
    bun: "bun add @v0xoss/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@v0xoss/react";',
    individual: 'import {User} from "@v0xoss/user";',
  }}
/>

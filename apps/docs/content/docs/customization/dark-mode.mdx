...
you can use the [@v0xoss/use-theme](https://github.com/vezham/heroui/tree/canary/packages/hooks/use-theme) hook to switch between themes.

<Steps> 

### Install @v0xoss/use-theme

Install `@v0xoss/use-theme` in your project.

<PackageManagers
  commands={{
    npm: 'npm install @v0xoss/use-theme',
    yarn: 'yarn add @v0xoss/use-theme',
    pnpm: 'pnpm add @v0xoss/use-theme',
  }}
/> 

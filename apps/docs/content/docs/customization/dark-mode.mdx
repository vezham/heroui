...
you can use the [@vezham/use-theme](https://github.com/vezham/heroui/tree/canary/packages/hooks/use-theme) hook to switch between themes.

<Steps> 

### Install @vezham/use-theme

Install `@vezham/use-theme` in your project.

<PackageManagers
  commands={{
    npm: 'npm install @vezham/use-theme',
    yarn: 'yarn add @vezham/use-theme',
    pnpm: 'pnpm add @vezham/use-theme',
  }}
/> 

...
you can use the [@vx-oss/use-theme](https://github.com/vezham/heroui/tree/canary/packages/hooks/use-theme) hook to switch between themes.

<Steps> 

### Install @vx-oss/use-theme

Install `@vx-oss/use-theme` in your project.

<PackageManagers
  commands={{
    npm: 'npm install @vx-oss/use-theme',
    yarn: 'yarn add @vx-oss/use-theme',
    pnpm: 'pnpm add @vx-oss/use-theme',
  }}
/> 

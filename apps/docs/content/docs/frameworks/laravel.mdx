...
<PackageManagers
  commands={{
    npm: 'npx create-laravel@latest --template https://github.com/vezham/laravel-template',
    yarn: 'yarn create laravel --template https://github.com/vezham/laravel-template',
    pnpm: 'pnpm create laravel --template https://github.com/vezham/laravel-template',
    bun: 'bunx create-laravel@latest --template https://github.com/vezham/laravel-template',
  }}
/>
...
```js {2,8,13-14}
// tailwind.config.js
const { heroui } = require("@vezham/react");

...
<PackageManagers
  commands={{
    npm: 'npx create-next-app -e https://github.com/vezham/next-app-template',
    yarn: 'yarn create next-app -e https://github.com/vezham/next-app-template',
    pnpm: 'pnpm create next-app -e https://github.com/vezham/next-app-template',
    bun: 'bunx create-next-app -e https://github.com/vezham/next-app-template'
  }}
/>
...
Or you can add the main library `@vezham/react` by running the following command:
...
<PackageManagers
  commands={{
    npm: 'npm i @vezham/react framer-motion',
    yarn: 'yarn add @vezham/react framer-motion',
    pnpm: 'pnpm add @vezham/react framer-motion',
    bun: "bun add @vezham/react framer-motion"
  }}
/>
...
```js {2,9,14-15}
// tailwind.config.js
import {heroui} from "@vezham/react";
...
```
> **Important 🚨**: Note that you need to import the component from the individual package, not from `@vezham/react`. 
...
<PackageManagers
  commands={{
    npm: 'npx create-next-app -e https://github.com/vezham/next-pages-template',
    yarn: 'yarn create next-app -e https://github.com/vezham/next-pages-template',
    pnpm: 'pnpm create next-app -e https://github.com/vezham/next-pages-template'
  }}
/>

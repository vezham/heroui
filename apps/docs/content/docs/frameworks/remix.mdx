...
<PackageManagers
  commands={{
    npm: 'npx create-remix@latest --template https://github.com/vezham/remix-template',
    yarn: 'yarn create remix --template https://github.com/vezham/remix-template',
    pnpm: 'pnpm create remix --template https://github.com/vezham/remix-template',
    bun: 'bunx create-remix@latest --template https://github.com/vezham/remix-template',
  }}
/>

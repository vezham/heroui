...
<PackageManagers
  commands={{
    npm: 'npx degit https://github.com/vezham/vite-template my-vite-app',
    yarn: 'yarn dlx degit https://github.com/vezham/vite-template my-vite-app',
    pnpm: 'pnpm dlx degit https://github.com/vezham/vite-template my-vite-app',
    bun: 'bunx degit https://github.com/vezham/vite-template my-vite-app',
  }}
/>

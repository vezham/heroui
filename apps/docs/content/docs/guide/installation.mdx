...
Or you can add the main library `@v0xoss/react` by running the following command:
...
<PackageManagers
  commands={{
    npm: "npm install @v0xoss/react framer-motion",
    yarn: "yarn add @v0xoss/react framer-motion",
    pnpm: "pnpm add @v0xoss/react framer-motion",
    bun: "bun add @v0xoss/react framer-motion"
  }}
/>
...
@source '../../node_modules/@v0xoss/theme/dist/**/*.{js,ts,jsx,tsx}';
...
<PackageManagers
  commands={{
    npm: "npm install @v0xoss/theme @v0xoss/system framer-motion",
    yarn: "yarn add @v0xoss/theme @v0xoss/system framer-motion",
    pnpm: "pnpm add @v0xoss/theme @v0xoss/system framer-motion",
    bun: "bun add @v0xoss/theme @v0xoss/system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @v0xoss/button",
    yarn: "yarn add @v0xoss/button",
    pnpm: "pnpm add @v0xoss/button",
    bun: "bun add @v0xoss/button"
  }}
/>
...
```js
// tailwind.config.js
const {heroui} = require("@v0xoss/theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@v0xoss/theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@v0xoss/theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },

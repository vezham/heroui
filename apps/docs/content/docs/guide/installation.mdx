...
Or you can add the main library `@vx-oss/react` by running the following command:
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/react framer-motion",
    yarn: "yarn add @vx-oss/react framer-motion",
    pnpm: "pnpm add @vx-oss/react framer-motion",
    bun: "bun add @vx-oss/react framer-motion"
  }}
/>
...
@source '../../node_modules/@vx-oss/theme/dist/**/*.{js,ts,jsx,tsx}';
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/theme @vx-oss/system framer-motion",
    yarn: "yarn add @vx-oss/theme @vx-oss/system framer-motion",
    pnpm: "pnpm add @vx-oss/theme @vx-oss/system framer-motion",
    bun: "bun add @vx-oss/theme @vx-oss/system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/button",
    yarn: "yarn add @vx-oss/button",
    pnpm: "pnpm add @vx-oss/button",
    bun: "bun add @vx-oss/button"
  }}
/>
...
```js
// tailwind.config.js
const {heroui} = require("@vx-oss/theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@vx-oss/theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@vx-oss/theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },

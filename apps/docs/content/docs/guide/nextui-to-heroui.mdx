...
<PackageManagers
  commands={{
    npm: "npx @v0xoss/codemod@latest migrate",
    pnpm: "pnpm dlx @v0xoss/codemod@latest migrate",
    yarn: "yarn dlx @v0xoss/codemod@latest migrate",
    bun: "bunx --bun @v0xoss/codemod@latest migrate"
  }}
/>
...
- Update all package names from `@nextui-org/*` to `@v0xoss/*`
...
<PackageManagers
  commands={{
    npm: "npm uninstall @nextui-org/react && npm install @v0xoss/react",
    yarn: "yarn remove @nextui-org/react && yarn add @v0xoss/react",
    pnpm: "pnpm remove @nextui-org/react && pnpm add @v0xoss/react",
    bun: "bun remove @nextui-org/react && bun add @v0xoss/react"
  }}
/>
...
// After
import {Button, Input} from "@v0xoss/react";
```
...
import {heroui} from "@v0xoss/theme";
import {HeroUIProvider} from "@v0xoss/react";
```
...
If you encounter any issues during migration, please [open an issue](https://github.com/vezham/heroui/issues) on our GitHub repository.

...
<PackageManagers
  commands={{
    npm: "npx @vx-oss/codemod@latest migrate",
    pnpm: "pnpm dlx @vx-oss/codemod@latest migrate",
    yarn: "yarn dlx @vx-oss/codemod@latest migrate",
    bun: "bunx --bun @vx-oss/codemod@latest migrate"
  }}
/>
...
- Update all package names from `@nextui-org/*` to `@vx-oss/*`
...
<PackageManagers
  commands={{
    npm: "npm uninstall @nextui-org/react && npm install @vx-oss/react",
    yarn: "yarn remove @nextui-org/react && yarn add @vx-oss/react",
    pnpm: "pnpm remove @nextui-org/react && pnpm add @vx-oss/react",
    bun: "bun remove @nextui-org/react && bun add @vx-oss/react"
  }}
/>
...
// After
const {heroui} = require("@vx-oss/react");
...
// After
import {Button, Input} from "@vx-oss/react";
```
...
import {heroui} from "@vx-oss/theme";
import {HeroUIProvider} from "@vx-oss/react";
```

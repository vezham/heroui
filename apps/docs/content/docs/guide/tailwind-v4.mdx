...
<PackageManagers
  commands={{
    cli: "npx vezham-cli@latest upgrade --all --beta",
    pnpm: "pnpm install @v0xoss/react@beta",
    npm: "npm install @v0xoss/react@beta",
    yarn: "yarn install @v0xoss/react@beta",
    bun: "bun install @v0xoss/react@beta"
  }}
/>
...
- [Open an issue](https://github.com/vezham/heroui/issues) on our GitHub repository

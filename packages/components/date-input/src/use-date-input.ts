import type {DateInputVariantProps, DateInputSlots, SlotsToClasses} from "@vx-oss/theme";
...
import type {PropGetter, HTMLHeroUIProps} from "@vx-oss/system";
...
import {dateInput, cn} from "@vx-oss/theme";

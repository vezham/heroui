...
import type {LinkVariantProps} from "@vx-oss/theme";
...
export function useLink(originalProps: UseLinkProps) {
  ...
  // use `@vx-oss/use-aria-link` to suppress onClick deprecation warning
